...
_Update (November 25 2019) :_ The goal was adapted : the project aims to predict the result of inspections based on a seat of features including inspections' and restaurants' characteristics.
